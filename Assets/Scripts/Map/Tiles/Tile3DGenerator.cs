    ...
    private bool GenerateAllPossibleTiles()
    {
        ...
        while (iterations++ < maxIterations)
        {
            ...
            while (recalcPossibleTilesQueue.Count > 0 && innerIterations++ < maxInnerIterations)
            {
                ...
                GridTileNode node = levelManager.mapManager.gridTileHelper.GetNode(position.x, position.z);
                ...
                if (possibleTilesHere.Count == 0)
                {
                    ...
                    GridTileNode node1 = levelManager.mapManager.gridTileHelper.GetNode(pos1.x, pos1.z);
                    ...
                    GridTileNode node2 = levelManager.mapManager.gridTileHelper.GetNode(pos2.x, pos2.z);
                    ...
                    GridTileNode node3 = levelManager.mapManager.gridTileHelper.GetNode(pos3.x, pos3.z);
                    ...
                    GridTileNode node4 = levelManager.mapManager.gridTileHelper.GetNode(pos4.x, pos4.z);
