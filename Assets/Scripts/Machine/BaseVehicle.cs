...
//     [SerializeField] private DataVehicle data = new();
//     public DataVehicle Data => data;
//     [SerializeField] private BaseVehicle _objectTarget;
//     public BaseVehicle ObjectTarget => _objectTarget;
...
//         // Debug.Log($"vertices length = {cubeMesh.vertices.Length}");
//         // Vector3[] vertices = cubeMesh.vertices;
        
//         // for (var i = 0; i < cubeMesh.vertices.Length - 300; i++)
//         // {
