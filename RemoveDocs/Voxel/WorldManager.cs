...
namespace Mikalai2006.Voxel
{
    public class WorldManager : MonoBehaviour
    {
        ...
        {
            Dictionary<Vector3Int, bool> dictionaryVoxels = sOVoxelData.voxels.ToDictionary(t => t, s => true);
        ...
        private int GetVoxelNeighbours(Vector3Int pos, Dictionary<Vector3Int, bool> allVoxels)
        {
            int i = 0;
            ...
            {
                Vector3Int nPos = Vector3Int.FloorToInt(pos + coordsNeighbours[x]);
                bool value = false;
        ...
        public MeshData[] CreateContainer(SOVoxelData sOVoxelData, float scale = 1, bool isDrawMesh = true)
        {
            ...
            container.SetData(sOVoxelData, 0, false, scale);
